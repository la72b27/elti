...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'unsafe-inline' https://cdn.jsdelivr.net; style-src 'unsafe-inline' https://cdn.jsdelivr.net; connect-src 'self' https://www.onemap.gov.sg https://cdn.jsdelivr.net; img-src 'self' data: https://*.tile.openstreetmap.org; frame-ancestors 'none'">
...
async def on_fetch(request, env):
    try:
        ...
        return Response.new(html, headers=Headers.new([
            ...
            ["Content-Security-Policy", "default-src 'self'; script-src 'unsafe-inline' https://cdn.jsdelivr.net; style-src 'unsafe-inline' https://cdn.jsdelivr.net; connect-src 'self' https://www.onemap.gov.sg https://cdn.jsdelivr.net; img-src 'self' data: https://*.tile.openstreetmap.org; frame-ancestors 'none'"],
        ]))
