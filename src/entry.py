...
<body>
    <div class="container-fluid">
        ...
        <div class="header-btns">
            ...
            <button class="btn btn-stat btn-route-toggle" id="routeBtn">Route 0</button>
        </div>
        ...
        <div class="table-container">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
                        <th><button class="sort-btn" onclick="sortByExclude(this)" title="Sort: checked rows to top">○</button></th>
    ...
    <script>
        ...
        function updateRouteCount() {
            const count = data.records.filter(r => {
                ...
                return pc && pc !== '-' && !excludedPostcodes.has(pc);
            }).length;
            document.getElementById('routeBtn').textContent = 'Route ' + count;
        }
        ...
        function render() {
            ...
            filteredRecords.forEach(row => {
                ...
                radio.addEventListener('change', function() {
                    ...
                    if (excludedPostcodes.size > 0) {
                        localStorage.setItem(EXCLUDE_PC_KEY, JSON.stringify([...excludedPostcodes]));
                    } else {
